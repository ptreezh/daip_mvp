...
- **FR-002**: System MUST provide both CLI and TUI interfaces for all core functionality
...
- **[Entity 1]**: [What it represents, key attributes without implementation, following Pydantic models in core/models.py]
- **[Entity 2]**: [What it represents, relationships to other entities, following Pydantic models in core/models.py]
...
- **SC-005**: [Quality metric, e.g., "Feature has ≥90% test coverage"]
- **SC-006**: [Architecture metric, e.g., "All components use event-driven communication patterns"]
