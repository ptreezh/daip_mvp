...
def create_role(
    ...
    position: str = typer.Option("supporting", help="Role position: supporting, opposing, neutral, or moderator"),
    ...
    try:
        ...
        if role_name:
            ...
            persona = role_manager._generate_role_persona(topic, position, topic_analysis)
        ...
        if role:
            ...
            if save_success:
                ...
                typer.echo(f"⚠️  Failed to save role to file")
        else:
...
def analyze_topic(
    topic: str = typer.Argument(..., help="The debate topic to analyze")
):
...
def suggest_roles(
    ...
    try:
        ...
        suggested_roles = role_manager.suggest_roles_for_topic(topic, available_roles, num_suggestions=num_roles)
...
def check_models():
    ...
    try:
        ...
        if available_models:
            ...
            typer.echo("⚠️  No models available. Please check your model provider setup.")
...
def auto_select_roles(
    ...
    try:
        ...
        selected_roles = role_manager.auto_select_roles(topic, available_roles, num_roles=num_roles)
