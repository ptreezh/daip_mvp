...
class SimpleDebateManager:
    ...
    def __init__(
        self, session_manager, role_manager, role_model_manager, model_provider
    ):
    ...
    def start_debate(
        self, topic: str, roles: list[str], session_id: Optional[str] = None
    ) -> str:
        """
    ...
    def add_participant(
        self, session_id: str, role_name: str, model_name: Optional[str] = None
    ) -> bool:
        """
        ...
        """
        if (
            not hasattr(self, "_active_debates")
            or session_id not in self._active_debates
        ):
            return False
        ...
        participant_info = {"role": role_name, "model": model_name or "default"}
    ...
    def get_debate_model_summary(self, roles: list[str]) -> dict[str, Any]:
        ...
        return {
            ...
            "total_models": len({self.model_provider.get_default_model() or "default"}),
