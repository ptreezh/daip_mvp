...
def test_basic_functionality():
    ...
    with patch(
        ...
        try:
            ...
            # 测试命令处理器
            assert hasattr(tui.command_handler, "handle_command"), (
                "Command handler should exist"
            )
...
def test_command_dispatch():
    ...
    with patch(
        ...
        try:
            ...
            assert hasattr(tui, "_handle_claude_skills_list_command"), (
                "Claude skills list command handler should exist"
            )
            assert hasattr(tui, "_handle_claude_skills_run_command"), (
                "Claude skills run command handler should exist"
            )

            # 测试会话命令处理存在（后台功能）
            assert hasattr(tui, "_handle_session_command"), (
                "Session command handler should exist"
            )
...
def test_specific_claude_skills_backend():
    ...
    with patch(
        ...
        try:
            ...
            assert hasattr(tui, "_claude_skill_adapter_manager"), (
                "Claude Skills adapter manager should be initialized"
            )
