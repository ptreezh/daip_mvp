...
class StatusBarComponent(TUIComponent):
    ...
    def set_status(self, status_text: str) -> None:
        ...
        """
        self.update_state(
            status_text=status_text, last_update=self._get_current_timestamp()
        )
