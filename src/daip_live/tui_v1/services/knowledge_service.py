...
class KnowledgeServiceAdapter(BaseServiceAdapter):
    ...
    async def search_documents(
        self, query: str, search_type: str = "fulltext"
    ) -> list[dict]:
        ...
        try:
                ...
                results = [
                    {
                        ...
                        "title": "Microservices",
                        "relevance": 0.95,
                        "content": "Content about microservices...",
                    },
                    {
                        "id": "doc2",
                        "title": "Architecture",
            ...
            logger.info(
                f"Knowledge search for '{query}' returned {len(results)} results"
            )
            return results
    ...
    async def add_document(self, file_path: str) -> dict:
        ...
        try:
            ...
            self.emit_event(
                ...
                {"file_path": file_path, "document_id": result.get("id")},
            )
            ...
            self.emit_event(
                "knowledge_error", {"error": str(e), "file_path": file_path}
            )
            raise
    ...
    async def sync_knowledge_base(self) -> dict:
        ...
        try:
            ...
            logger.info(
                f"Knowledge base sync completed: {result.get('documents')} documents"
            )
            return result
        except Exception as e:
    ...
    async def get_document(self, document_id: str) -> Optional[dict]:
        ...
        try:
            ...
            self.emit_event(
                "knowledge_error", {"error": str(e), "document_id": document_id}
            )
            return None
    ...
    async def update_document(self, document_id: str, content: str) -> dict:
        ...
        try:
            ...
            self.emit_event(
                ...
                {"document_id": document_id, "content_length": len(content)},
            )
    ...
    async def delete_document(self, document_id: str) -> bool:
        ...
        try:
            ...
            if success:
                self.emit_event(
                    "knowledge_document_deleted", {"document_id": document_id}
                )
                ...
                documents = [
                    {
                        ...
                        "updated_at": f"2025-11-02T{10 + i}:00:00Z",
                    }
