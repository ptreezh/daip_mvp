...
class ModelServiceAdapter(BaseServiceAdapter):
    ...
    async def list_models(self) -> List[Dict]:
        ...
        try:
            if self.service and hasattr(self.service, 'list_models'):
                ...
                models = [
                    {"name": "gpt-4o-mini", "provider": "OpenAI", "status": "available", "type": "chat"},
                    {"name": "claude-3-sonnet", "provider": "Anthropic", "status": "available", "type": "chat"},
                    {"name": "llama-3-70b", "provider": "Local", "status": "unavailable", "type": "chat"},
                    {"name": "gemini-pro", "provider": "Google", "status": "available", "type": "chat"}
                ]
    ...
    async def get_model_status(self, model_name: str) -> Dict:
        ...
        try:
            ...
            self.emit_event('model_status_checked', {
    ...
    async def switch_model(self, model_name: str) -> Dict:
        ...
        try:
            ...
            if self.service and hasattr(self.service, 'switch_model'):
                ...
                # Check if result is a Mock object (indicates service is not properly implemented)
            ...
            self.emit_event('model_switched', {
                'model_name': model_name,
    ...
    async def get_model_metrics(self, model_name: str) -> Dict:
        ...
        try:
            ...
            self.emit_event('model_metrics_retrieved', {
                'model_name': model_name,
                'metrics': metrics
            })
            return metrics
    ...
    async def configure_model(self, model_name: str, config: Dict) -> Dict:
        ...
        try:
            ...
            self.emit_event('model_configured', {
                'model_name': model_name,
                'configuration': config
            })
    ...
    async def get_model_usage_stats(self, model_name: str, time_period: str = "24h") -> Dict:
