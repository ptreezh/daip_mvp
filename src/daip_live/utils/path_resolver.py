...
def find_roles_directory(
    roles_dir: str = "roles", start_path: Optional[str] = None
) -> Optional[Path]:
    """
    ...
    for path in unique_search_paths:
        try:
            ...
            # Skip paths that can't be resolved (e.g. due to permissions or circular symlinks)  # noqa: E501
            continue
