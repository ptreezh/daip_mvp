"""
@Time    : 2025-08-04 12:00:00
@Author  : DAIP-LIVE Team
@File    : perspective_visualizer.py
@Description:
    Multi-Perspective Visualizer for synthesis results and analysis.
"""
...
class MultiPerspectiveVisualizer:
    ...
    async def create_visualization(
        ...
        try:
            ...
            viz_methods = {
                VisualizationType.PERSPECTIVE_RADAR: self._create_perspective_radar,
                VisualizationType.QUALITY_HEATMAP: self._create_quality_heatmap,
                VisualizationType.CONSENSUS_TREEMAP: self._create_consensus_treemap,
                VisualizationType.PERFORMANCE_TIMELINE: self._create_performance_timeline,
                VisualizationType.CONFLICT_NETWORK: self._create_conflict_network,
                VisualizationType.INSIGHT_WORDCLOUD: self._create_insight_wordcloud,
                VisualizationType.WEIGHT_DISTRIBUTION: self._create_weight_distribution,
                VisualizationType.SYNTHESIS_DASHBOARD: self._create_synthesis_dashboard
            }
    ...
    async def _create_perspective_radar(self, data: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _create_quality_heatmap(self, data: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _create_consensus_treemap(self, data: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _create_performance_timeline(self, data: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _create_insight_wordcloud(self, data: Dict[str, Any], config: Dict[str, Any]) -> Dict[str, Any]:
