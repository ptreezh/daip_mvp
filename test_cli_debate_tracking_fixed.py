...
"""
    ...
    try:
        ...
        print(f"✓ All histories after adding test debate: {len(all_histories_after)}")
        
        # 6. Look for our specific debate in the results
        found_our_debate = False
        for hist in all_histories_after:
            if hist.session_id == "cli_tracking_test_001":  # Fixed to use correct ID
        ...
        # Test retrieving specific history
        ...
        # Test creating debate through EnhancedDebateManager
        ...
        # Create mock components to avoid API calls
        mock_provider = Mock()
