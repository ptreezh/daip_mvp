...
async def test_complete_wiki_workflow():
    ...
    mock_role_manager.list_roles.return_value = ["domain_expert", "researcher", "editor", "critic", "tech_analyst"]
    ...
    print("\n3. 测试角色模型管理器...")
    mock_role_manager = MagicMock(spec=RoleManager)
    mock_role_manager.get_role_info.return_value = {
    ...
    # 创建映射对象
    mapping1 = MagicMock(spec=RoleModelMapping)
    ...
    mapping2 = MagicMock(spec=RoleModelMapping)
    ...
    mapping3 = MagicMock(spec=RoleModelMapping)
    ...
    mapping4 = MagicMock(spec=RoleModelMapping)
    ...
    role_model_manager.get_debate_model_mappings.return_value = [mapping1, mapping2, mapping3, mapping4]
    ...
    debate_manager = MagicMock(spec=EnhancedDebateManager)
    ...
    def get_mock_mappings(role_names):
        ...
        for i, role_name in enumerate(role_names):
            mapping = MagicMock(spec=RoleModelMapping)
    ...
    mock_role_model_manager.get_debate_model_mappings.side_effect = get_mock_mappings
