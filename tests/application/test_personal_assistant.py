...
from src.domain.value_objects import EntranceType, IntentType, TaskStatus, ConsensusLevel
...
class TestPersonalAssistantService:
    ...
    def assistant_service(self):
        ...
        return PersonalAssistantService()
    ...
    async def test_process_secretariat_input(self, assistant_service):
        ...
        with patch('src.application.personal_assistant_service.SecretariatUseCase') as mock_secretariat:
            ...
            mock_secretariat_instance.submit_task = AsyncMock(return_value={
                \"task_id\": \"test_task\",
                \"workflow_id\": \"test_workflow\",
                \"estimated_duration\": 10.0
            })
            
            # Replace the actual secretariat use case with the mock
            assistant_service.secretariat_use_case = mock_secretariat_instance
