...
class WorkflowTestRunner:
    ...
    async def simulate_workflow_commands(self, commands: List[str], workflow_name: str, delay: float = 2.0):
        """模拟工作流命令序列"""
    ...
    async def test_research_workflow(self):
        ...
        await self.simulate_workflow_commands(research_commands, "研究工作流", delay=1.5)
    ...
    async def test_learning_workflow(self):
        ...
        await self.simulate_workflow_commands(learning_commands, "学习工作流", delay=1.5)
    ...
    async def test_collaboration_workflow(self):
        ...
        await self.simulate_workflow_commands(collaboration_commands, "协作工作流", delay=1.5)
    ...
    async def test_productivity_workflow(self):
        ...
        await self.simulate_workflow_commands(productivity_commands, "生产力工作流", delay=1.5)
        ...
        response_time = time.time() - start_time
        self.log_test("生产力工作流程", "PARTIAL", "完整生产力流程模拟完成", response_time)
    ...
    async def test_error_recovery_workflow(self):
        ...
        await self.simulate_workflow_commands(error_recovery_commands, "错误恢复工作流", delay=1.0)
        ...
        response_time = time.time() - start_time
        self.log_test("错误恢复工作流程", "PARTIAL", "完整错误恢复流程模拟完成", response_time)
