...
from daip_live.p4_role_manager_tools.tool_extension import tool, ToolExtensionManager, ToolMetadata
...
class TestEnhancedToolExtension:
    ...
    def test_tool_decorator_with_enhanced_metadata(self):
        ...
        def enhanced_write_file(file_path: str, content: str, encoding: str = "utf-8") -> str:
        ...
        assert enhanced_write_file.is_tool == True
        ...
        assert enhanced_write_file.is_write == True
    ...
    def test_tool_extension_manager_registration(self):
        ...
        assert tool_info["description"] == "Calculates base raised to the power of exponent."
