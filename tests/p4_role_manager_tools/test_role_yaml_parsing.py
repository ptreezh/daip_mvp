...
class TestRoleYamlParsing(unittest.TestCase):
    ...
    def test_enhanced_role_parses_debate_config_from_dict(self):
        """
        [GREEN] TDD Test: Validates that EnhancedRole correctly parses `debate_model_config`
        ...
        self.assertIsNotNone(
            ...
            "Validation failed: `debate_model_config` should be parsed and not be None."
        )
        ...
        self.assertIsInstance(
            role.debate_model_config,
            RoleModelConfig,
            f"Validation failed: `debate_model_config` should be an instance of RoleModelConfig, but got {type(role.debate_model_config)}."
        )
        ...
        self.assertEqual(
            ...
            "Validation failed: The model name within `debate_model_config` was not parsed correctly."
        )
