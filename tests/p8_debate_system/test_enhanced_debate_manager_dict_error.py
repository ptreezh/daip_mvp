...
from daip_live.core.models import DialogueTurn, Session, AgentState
from daip_live.p8_debate_system.enhanced_debate_manager import EnhancedDebateManager
from daip_live.memory.session_manager import SessionManager
from daip_live.model_provider.provider import LiteLLMProvider
from daip_live.p4_role_manager_tools.role_manager import RoleManager, Role
...
class TestEnhancedDebateManagerDictError:
    ...
    def mock_dependencies(self):
        ...
        mock_mapping1.role_model_config = mock_model_config1  # 注意：这里是role_model_config
        ...
        mock_mapping2.role_model_config = mock_model_config2  # 注意：这里是role_model_config
        mock_mapping2.priority = 2

        mock_role_model_manager.get_debate_model_mappings.return_value = [
            mock_mapping1, mock_mapping2
        ]
    ...
    def test_legacy_mode_fixed_role_config_error(self, mock_dependencies):
        ...
        mock_content = "This is my argument"
        mock_usage = {"total_tokens": 100}
        mock_dependencies['model_provider'].generate.return_value = (mock_content, mock_usage)
        ...
        # 验证没有错误发生
        error_events = [e for e in events if hasattr(e, 'message') and 'error' in str(type(e)).lower()]
