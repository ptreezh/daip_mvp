...
class TestAgentExecutorPermissionIntegration:
    ...
    async def test_agent_executor_permission_ask_user_grants(self):
        ...
        # assert permission_manager.get_cached_permissions().get("moderate_risk_tool") == PermissionResponse.GRANT  # noqa: E501
    ...
    async def test_agent_executor_permission_request_retry(self):
        ...
        # result = await agent_executor.execute_tool_with_permission(
        #     "test_tool", {"param": "value"}, SessionContext(), confirmation_granted=True  # noqa: E501
        # )
    ...
    async def test_agent_executor_permission_timeout(self):
        ...
        # 验证超时被视为权限拒绝
        # assert "timeout" in str(exc_info.value).lower() or "denied" in str(exc_info.value).lower()  # noqa: E501
    ...
    async def test_agent_executor_invalid_tool_permission(self):
        ...
        user_queue = asyncio.Queue()
        tui_interface = MagicMock()
        PermissionManager(user_queue, tui_interface)
...
class TestAgentExecutorPermissionRobustness:
    ...
    async def test_agent_executor_concurrent_permission_requests(self):
        ...
        # When: 并发检查多个权限
        # tasks = [
        #     agent_executor.execute_tool_with_permission("tool_1", {}, SessionContext()),  # noqa: E501
        #     agent_executor.execute_tool_with_permission("tool_2", {}, SessionContext()),  # noqa: E501
        #     agent_executor.execute_tool_with_permission("tool_3", {}, SessionContext()),  # noqa: E501
        # ]
        #
