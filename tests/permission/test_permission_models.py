...
# 待实现的导入
# from daip_live.core.models import PermissionResponse, PermissionState, PermissionInteraction  # noqa: E501
...
class TestPermissionResponseValidation:
    ...
    def test_case_insensitive_response(self):
        ...
        # Given: 大小写不同的输入
        test_cases = [
            ("y", "Y", PermissionResponse.GRANT),  # noqa: F821
            ("n", "N", PermissionResponse.DENY),  # noqa: F821
            ("a", "A", PermissionResponse.ALWAYS),  # noqa: F821
            ("v", "V", PermissionResponse.NEVER),  # noqa: F821
            ("c", "C", PermissionResponse.CANCEL),  # noqa: F821
        ]
