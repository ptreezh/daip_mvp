...
class TestKnowledgeSourceDB:
    ...
    def test_upsert_as_update(self, db_manager: DatabaseManager):
        ...
        initial_source = db_manager.upsert_knowledge_source(KnowledgeSource(
    ...
    def test_get_all_sources(self, db_manager: DatabaseManager):
        ...
        db_manager.upsert_knowledge_source(KnowledgeSource(file_path="f1.txt", file_hash="h1", status="indexed"))
        db_manager.upsert_knowledge_source(KnowledgeSource(file_path="f2.txt", file_hash="h2", status="pending"))
