...
from src.daip_live.skills.claude_skill_adapter import (
    ClaudeSkillAdapterManager,
    ...
    def test_skill_creation(self):
        ...
        class TestSkill(Skill):
            def execute(self, input: SkillInput) -> SkillOutput:
                return SkillOutput(
                    result="执行成功", confidence=0.9, execution_time=0.1
                )
...
class TestSkillManager:
    ...
    def test_register_skill(self):
        ...
        class TestRegisterSkill(Skill):
            def execute(self, input: SkillInput) -> SkillOutput:
                return SkillOutput(
                    result="注册测试成功", confidence=0.9, execution_time=0.1
                )
    ...
    def test_register_duplicate_skill_raises_error(self):
        ...
        class TestDuplicateSkill(Skill):
            def execute(self, input: SkillInput) -> SkillOutput:
                return SkillOutput(
                    result="重复测试", confidence=0.8, execution_time=0.1
                )
    ...
    def test_unregister_skill(self):
        ...
        class TestUnregisterSkill(Skill):
            def execute(self, input: SkillInput) -> SkillOutput:
                return SkillOutput(
                    result="注销测试", confidence=0.8, execution_time=0.1
                )
    ...
    def test_list_skills(self):
        ...
        for i in range(3):
            ...
            class TestListSkill(Skill):
                ...
                def execute(self, input: SkillInput) -> SkillOutput:
                    return SkillOutput(
                        result=f"列表测试{i}", confidence=0.8, execution_time=0.1
                    )
    ...
    def test_get_skill_metadata(self):
        ...
        class TestMetadataSkill(Skill):
            def execute(self, input: SkillInput) -> SkillOutput:
                return SkillOutput(
                    result="元数据测试", confidence=0.8, execution_time=0.1
                )
    ...
    def test_find_skills_by_tag(self):
        ...
        for i, meta in enumerate([metadata1, metadata2, metadata3]):
            ...
            class TestTagSkill(Skill):
                ...
                def execute(self, input: SkillInput) -> SkillOutput:
                    return SkillOutput(
                        result=f"标签测试{i}", confidence=0.8, execution_time=0.1
                    )
...
class TestClaudeSkillDefinition:
    ...
    def test_claude_skill_definition_creation(self):
        ...
        skill_def = ClaudeSkillDefinition(
            ...
            tags=["claude", "test"],
            tools=[
                {"name": "test_tool", "description": "测试工具", "type": "function"}
            ],
        )
...
class TestClaudeSkillAdapterManager:
    ...
    async def test_create_skill_adapter_from_claude_definition(self, temp_skills_dir):
        ...
        adapter = adapter_manager._create_skill_adapter_from_claude_definition(
            skill_def
        )
    ...
    async def test_load_claude_skills_from_directory_traditional_format(
        ...
        # 加载技能
        loaded_skills = await adapter_manager.load_claude_skills_from_directory(
            str(temp_skills_dir)
        )
    ...
    async def test_load_claude_skills_simple_method_traditional_format(
        self, temp_skills_dir
    ):
...
"""
    ...
    async def test_execute_skill(self, temp_skills_dir):
        ...
        # 执行技能
        result = await adapter_manager.execute_skill(
            "execute_test_skill", {"input": "执行测试输入"}
        )
...
class TestClaudeSkillsIntegration:
    ...
    async def test_complete_claude_skills_workflow(self, temp_skills_dir):
        ...
        # 6. 执行技能
        execution_result = await adapter_manager.execute_skill(
            "workflow_test_skill", {"input": "工作流测试"}
        )
...
class TestSkillsDirectoryLoading:
    ...
    def test_load_skills_from_directory(self, temp_skills_dir):
        ...
        # 内嵌模块须用 src.daip_live 前缀：manager 相对导入解析为 src.daip_live.skills.base.Skill，  # noqa: E501
...
async def run_all_async_tests():
    ...
    await adapter_test.test_load_claude_skills_from_directory_traditional_format(
        fresh_dir()
    )
    await adapter_test.test_load_claude_skills_simple_method_traditional_format(
        fresh_dir()
    )
