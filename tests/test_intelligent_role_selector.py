...
from src.daip_live.p8_debate_system.role_selector import IntelligentRoleSelector, TopicAnalysis
...
class TestIntelligentRoleSelector:
    ...
    def test_topic_analysis_technical_topic(self):
        ...
        # The topic should contain technology-related keywords even if domain isn't explicitly 'technology'
    ...
    def test_extract_role_features(self):
        ...
        relevant_keywords_found = any(keyword in features["keywords"]
    ...
    def test_calculate_relevance_score(self):
        ...
        features = self.selector.extract_role_features(role)
        relevance_score = self.selector.calculate_relevance_score(topic_analysis, features)
    ...
    def test_calculate_conflict_potential(self):
        ...
        conflict_score = self.selector.calculate_conflict_potential(features1, features2)
    ...
    def test_suggest_roles(self):
        ...
        suggestions = self.selector.suggest_roles("AI's impact on the economy", roles, num_suggestions=2)
        
        assert len(suggestions) == 2
        assert all(hasattr(s, 'role') and hasattr(s, 'relevance_score') for s in suggestions)
    ...
    def test_auto_select_roles(self):
        ...
        selected_roles = self.selector.auto_select_roles("AI's impact on the economy", roles, num_roles=2)
