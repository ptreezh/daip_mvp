...
between different components as specified in the command cleanup and status sync specification.
"""
...
class TestTokenCalculationConsistency:
    ...
    def test_token_calculation_consistency_between_components(self):
        ...
        provider_tokens = model_provider.count_tokens_for_conversation(test_conversation)
        ...
        assert provider_tokens == tui_tokens, \
            f"Model provider calculated {provider_tokens} tokens, TUI calculated {tui_tokens} tokens"
...
class TestTokenCalculationEdgeCases:
    ...
    def test_very_long_content_token_calculation(self):
        ...
        assert tokens < len(long_content) // 2  # Should be much less than character count
    ...
    def test_conversation_format_token_calculation(self):
        ...
        conversation_formats = [
            ...
            [
                ...
                {"role": "assistant", "content": "", "function_call": {"name": "get_weather"}},
...
class TestTokenPerformance:
    ...
    def test_token_calculation_caching(self):
        ...
        for _ in range(100):
            tokens = model_provider.count_tokens(test_content)
...
class TestTokenErrorHandling:
    ...
    def test_model_provider_unavailable_error_handling(self):
        ...
        mock_broken_provider.count_tokens.side_effect = Exception("Provider unavailable")
