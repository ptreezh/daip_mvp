...
class TestTUIInputHistory:
    ...
    def test_history_navigate_up(self, tui_with_history):
        ...
        # 模拟向上导航
        with patch.object(tui.query_one(Input), "value", "current input"):  # noqa: F821
...
class TestTUICommandHandlers:
    ...
    def tui_with_mocks(self):
        """创建带有完整Mock的TUI实例"""
        with (
            patch("daip_live.tui.SessionManager") as mock_session,
    ...
    def test_handle_run_command_with_goal(self, tui_with_mocks):
        ...
        with (
            patch("daip_live.tui.AgentExecutor") as mock_executor_class,
    ...
    def test_handle_run_command_without_goal(self, tui_with_mocks):
        ...
        tui._update_log_view.assert_called_with(
            "[bold red]> Usage: /run <goal>[/bold red]"
        )
    ...
    def test_handle_debate_start_command(self, tui_with_mocks):
        ...
        with patch("asyncio.create_task") as mock_create_task:
            tui._handle_debate_command(
                "start test topic --roles role1,role2 --rounds 3"
            )
    ...
    def test_handle_debate_start_without_topic(self, tui_with_mocks):
        ...
        # 应该显示错误消息
        tui._update_log_view.assert_called_with(
            "[bold red]> Usage: /debate start <topic> [--roles <roles>] [--rounds <rounds>][/bold red]"  # noqa: E501
        )
    ...
    def test_handle_project_command(self, tui_with_mocks):
        ...
        # 应该显示未实现消息
        tui._update_log_view.assert_called_with(
            "[bold yellow]> Project scaffold functionality not yet implemented in TUI. Use CLI: daip project scaffold[/bold yellow]"  # noqa: E501
        )
    ...
    def test_handle_project_command_without_args(self, tui_with_mocks):
        ...
        # 应该显示用法信息
        tui._update_log_view.assert_called_with(
            "[bold red]> Usage: /project scaffold --description <desc> or --from-file <file>[/bold red]"  # noqa: E501
        )
