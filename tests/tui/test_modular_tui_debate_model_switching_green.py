...
class TestModularTUIDebateModelSwitchingGreen:
    ...
    def test_green_debate_event_handling_updates_model(self, modular_tui_with_mocked_dependencies):
        ...
        # 创建辩论转次开始事件
        from daip_live.core.models import DebateTurnStartEvent
    ...
    def test_green_get_enhanced_status_text_shows_role_model(self):
        ...
        tui._system_activity = {'events_processed': 1, 'tools_executed': 1, 'errors_encountered': 0}
